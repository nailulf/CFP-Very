...
import { BadgeCheck, BarChart3, Package, Sprout, Users } from 'lucide-react';
...
const ServiceCard: React.FC<ServiceCardProps> = ({ iconBg, Icon, title, description, points, dark = false }) => {
  return (
    <div
