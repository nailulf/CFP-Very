...
export async function generateMetadata({
  ...
  const url = `/blog/${slug}`
  // Use the post's coverImage when present; otherwise fall back to the
  // site-wide default card generated by src/app/opengraph-image.tsx.
  // (Defining openGraph here suppresses the auto-inherited default, so we
