...
export const translations = {
  id: {
    navbar: {
      ...
      links: [
        { label: 'Cara Kerja', href: '/konsultasi' },
    ...
    home: {
      hero: {
        kicker: ['Financial planning', 'untuk kehidupan nyata'],
        headline: ['Rencanakan uangmu.', 'Bangun hidup yang', 'kamu mau.'],
        lede: 'Dari mengatur cash flow, membangun dana darurat, investasi, proteksi, sampai menyiapkan rumah, pendidikan anak, dan pensiun — kami bantu menyusun strategi keuangan yang sesuai dengan kondisi dan tujuan hidupmu.',
        ctaPrimary: 'Mulai Konsultasi',
        ctaSecondary: 'Lihat Layanan',
        stats: [
          { value: '50+', label: 'Klien didampingi' },
          { value: '2', label: 'Klien korporat' },
          { value: '64K+', label: 'Pengikut Instagram' },
        ],
        credential: {
          name: 'Aditya Very Cleverina, CFP\u00ae',
          role: 'Certified Financial Planner',
          meta: 'M.Sc. Sustainable Development \u00b7 Ex-Bank Indonesia',
        },
      },
      clients: {
      ...
      problem: {
        title: 'Mungkin kamu ada di sini?',
        lede: 'Penghasilan bertambah, tapi kok rasanya uang tetap nggak pernah cukup? Mungkin masalahnya bukan kamu kurang menghasilkan — bisa jadi uangmu belum punya sistem dan arah yang jelas.',
        items: [
          { state: 'Penghasilan sudah naik', consequence: 'Tapi belum punya sistem keuangan yang jelas.' },
          { state: 'Punya banyak financial goals', consequence: 'Rumah, menikah, anak, investasi, pensiun — semuanya penting, tapi bingung prioritasnya.' },
          { state: 'Sudah investasi', consequence: 'Tapi belum tahu apakah investasi yang dimiliki sudah sesuai tujuan.' },
          { state: 'Mulai membangun keluarga', consequence: 'Mulai memikirkan rumah, anak, proteksi, dan masa depan.' },
          { state: 'Punya cicilan', consequence: 'Ingin tahu apakah utang dan cicilan masih sehat.' },
          { state: 'Ingin hidup nyaman', consequence: 'Ingin menikmati hidup tanpa mengorbankan masa depan.' },
        ],
        close: 'Kalau kamu merasa relate dengan salah satunya, financial planning bisa membantu.',
        cta: 'Lihat bagaimana kami bisa membantu',
      },
      services: {
        title: 'Kenali kondisi keuanganmu. Susun langkah berikutnya.',
        lede: 'Kami bantu melihat kondisi keuanganmu secara menyeluruh, lalu menyusun langkah yang sesuai dengan hidupmu.',
        items: [
          {
            quote: 'Sebenarnya kondisi keuanganku sehat nggak?',
            name: 'Financial Health Check',
            desc: 'Review kondisi keuanganmu secara menyeluruh, dan tahu apa yang perlu diperbaiki.',
            cta: 'Cek gratis',
          },
          {
            quote: 'Aku tahu mau ke mana, tapi belum tahu caranya.',
            name: 'Personal Financial Planning',
            desc: 'Rencana keuangan menyeluruh untuk mencapai tujuan hidupmu, satu per satu.',
            cta: 'Lihat detail',
          },
          {
            quote: 'Kami ingin membangun masa depan bersama.',
            name: 'Couple & Family Planning',
            desc: 'Menyusun sistem keuangan pasangan dan keluarga: rumah, anak, proteksi, pensiun.',
            cta: 'Lihat detail',
          },
        ],
        cta: 'Belum tahu mana yang cocok? Mulai konsultasi',
      },
      corporate: {
        overline: 'Untuk perusahaan',
        title: ['Kami juga mengadakan training keuangan', 'untuk perusahaan.'],
        lede: 'Sesi praktis untuk karyawan Anda — cash flow, utang, proteksi, dan persiapan pensiun — dibawakan langsung oleh Certified Financial Planner. Tersedia dalam dua format.',
        items: [
          {
            label: 'Seminar',
            name: 'Financial Planning Workshop',
            desc: 'Seminar offline atau online untuk membantu karyawan memahami perencanaan keuangan pribadi.',
          },
          {
            label: 'In-house',
            name: 'Custom Corporate Program',
            desc: 'Training multi-sesi di perusahaan Anda, dirancang untuk tujuan yang spesifik.',
          },
        ],
        cta: 'Pelajari lebih lanjut',
        ctaNote: 'Kirim kebutuhan tim Anda, kami susun programnya.',
      },
      testimonials: {
        title: 'Mereka pernah ada di posisi yang sama.',
        lede: 'Dari bingung mulai dari mana, sampai akhirnya punya angka, prioritas, dan rencana yang jelas.',
        prev: 'Testimoni sebelumnya',
        next: 'Testimoni berikutnya',
        regionLabel: 'Testimoni klien',
        ...
        items: [
          {
            ...
            initials: 'RA',
            tag: 'Couple & Family Planning',
          },
          {
            quote: 'Yang paling kami apresiasi dari sesi ini adalah pendekatannya yang personal dan berbasis tujuan. Kami tidak hanya membahas produk atau instrumen investasi, tetapi juga menyusun strategi yang realistis sesuai target, jangka waktu, dan profil risiko kami. Setelah sesi, kami merasa lebih yakin dan memiliki arah yang jelas dalam mengelola keuangan untuk tujuan jangka pendek, menengah dan panjang.',
            name: 'Kurnia & Anna',
            role: 'Keluarga',
            initials: 'KA',
            tag: 'Couple & Family Planning',
          ...
          {
            quote: 'Very memberikan penjelasan yang mudah dicerna dan gampang diaplikasikan secara langsung. very juga sangat memahami concern dari kliennya <3',
            name: 'Atik',
            role: 'HR manager',
            initials: 'AN',
            tag: 'Personal Financial Planning',
          },
          {
            quote: 'Kami sangat terbantu dengan sesi konsultasi ini. Penyampaian materi dan solusi sangat mudah dipahami. Kami sangat merasa didengar, dipahami, dan rencana keuangan kedepan yang diberikan sangat relevan. Konsultannya juga ramah dan sangat komunikatif :)',
            name: 'Nabila & Theo',
            role: 'Keluarga',
            initials: 'NT',
            tag: 'Couple & Family Planning',
      ...
      products: {
        title: 'Mau mulai sendiri dulu? Bisa.',
        lede: 'Kalau belum siap melakukan financial planning, kamu bisa mulai dengan tools yang membantu memahami dan mengatur keuangan sendiri.',
        free: 'Gratis',
        download: 'Unduh',
        view: 'Lihat',
        prev: 'Produk sebelumnya',
        next: 'Produk berikutnya',
        regionLabel: 'Daftar produk digital',
        cta: 'Lihat semua financial tools',
      },
      finalCTA: {
        headline: 'Keuangan belum ideal bukan alasan untuk menunda perencanaan.',
        lede: 'Mulai dari kondisi kamu hari ini. Kita susun langkah berikutnya bersama.',
        ctaPrimary: 'Mulai Konsultasi',
        ctaSecondary: 'Financial Health Check gratis',
        assurances: ['Tanpa menghakimi', 'Tanpa template yang dipaksakan', 'Rencana yang dibuat untuk kamu'],
      },
    },
    hero: {
  ...
  en: {
    navbar: {
      ...
      links: [
        { label: 'How It Works', href: '/konsultasi' },
        { label: 'Blog', href: '/blog' },
    ...
    home: {
      hero: {
        kicker: ['Financial planning', 'for real life'],
        headline: ['Plan your money.', 'Build the life', 'you actually want.'],
        lede: 'From cash flow and an emergency fund to investing, protection, a home, your children\u2019s education and retirement — we help you build a financial strategy that fits your situation and your goals.',
        ctaPrimary: 'Start a Consultation',
        ctaSecondary: 'See Services',
        stats: [
          { value: '50+', label: 'Clients guided' },
          { value: '2', label: 'Corporate clients' },
          { value: '64K+', label: 'Instagram followers' },
        ],
        credential: {
          name: 'Aditya Very Cleverina, CFP\u00ae',
          role: 'Certified Financial Planner',
      ...
      problem: {
        ...
        lede: 'Your income keeps growing, so why does it never feel like enough? The problem may not be how much you earn — it may be that your money has no system and no direction.',
        items: [
          { state: 'Your income has grown', consequence: 'But there is still no clear system behind it.' },
          { state: 'You have a lot of financial goals', consequence: 'A home, a wedding, children, investing, retirement — all of it matters, but which comes first?' },
          { state: 'You already invest', consequence: 'But you are not sure whether what you hold actually matches your goals.' },
          { state: 'You are starting a family', consequence: 'A home, children, protection and the years ahead are all on your mind.' },
          { state: 'You are carrying debt', consequence: 'And you want to know whether your loans are still healthy.' },
          { state: 'You want to live well', consequence: 'Without trading away your future to do it.' },
        ],
        close: 'If any of these sound like you, financial planning can help.',
        cta: 'See how we can help',
      },
      services: {
        title: 'You do not have to figure all of this out alone.',
        lede: 'We help you see your finances as a whole, then build the steps that fit your life.',
        items: [
          {
            quote: 'Is my financial situation actually healthy?',
            name: 'Financial Health Check',
            desc: 'A full review of where your money stands today, and what needs fixing first.',
            cta: 'Check for free',
          },
          {
            quote: 'I know where I want to go. I just do not know how.',
            name: 'Personal Financial Planning',
            desc: 'A complete plan that moves you toward your goals, one at a time.',
            cta: 'See details',
          },
          {
            quote: 'We want to build our future together, properly.',
            name: 'Couple & Family Planning',
            desc: 'A shared financial system for couples and families: home, children, protection, retirement.',
            cta: 'See details',
          },
        ],
        cta: 'Not sure which fits? Start a consultation',
      },
      corporate: {
        overline: 'For organisations',
        title: ['We also run financial training', 'for companies.'],
        lede: 'Practical sessions for your employees — cash flow, debt, protection and retirement — delivered by a Certified Financial Planner. Available in two formats.',
        items: [
          {
            label: 'Seminar',
            name: 'Financial Planning Workshop',
            desc: 'An offline or online seminar helping employees understand personal financial planning.',
          },
          {
            label: 'In-house',
            name: 'Custom Corporate Program',
            desc: 'Multi-session training at your company, designed around a specific objective.',
          },
        ],
        cta: 'Request a proposal',
        ctaNote: 'Tell us what your team needs and we will design the program.',
      },
      testimonials: {
        title: 'They were once exactly where you are.',
        lede: 'From not knowing where to start, to having real numbers, clear priorities and a plan.',
        ...
        items: [
          ...
          {
            quote: 'What we appreciated most about this session was how personal and goal-based the approach was. We did not only discuss products or investment instruments \u2014 we built a realistic strategy around our targets, our timeframes and our risk profile. Afterwards we felt more confident, with a clear direction for managing our money across short, medium and long-term goals.',
            name: 'Kurnia & Anna',
            role: 'Family',
            initials: 'KA',
            tag: 'Couple & Family Planning',
          ...
          {
            quote: 'Very explains things in a way that is easy to take in and easy to apply straight away. She also really understands what her clients are worried about <3',
            name: 'Atik',
            role: 'HR Manager',
            initials: 'AN',
            tag: 'Personal Financial Planning',
          ...
          {
            quote: 'This consultation helped us enormously. The way the material and the solutions were explained was very easy to follow. We genuinely felt heard and understood, and the financial plan we were given was highly relevant. Our consultant was warm and very communicative :)',
            name: 'Nabila & Theo',
            role: 'Family',
            initials: 'NT',
            tag: 'Couple & Family Planning',
      ...
      products: {
        title: 'Want to start on your own first? You can.',
        lede: 'If you are not ready for full financial planning yet, start with tools that help you understand and organise your money yourself.',
        free: 'Free',
        download: 'Download',
        view: 'View',
        prev: 'Previous product',
        next: 'Next product',
        regionLabel: 'Digital product list',
        cta: 'See all financial tools',
      },
      finalCTA: {
        headline: 'You do not need your finances to be perfect before you start planning them.',
        lede: 'Start from where you are today. We will build the next steps together.',
        ctaPrimary: 'Start a Consultation',
        ctaSecondary: 'Free Financial Health Check',
        assurances: ['No judgement', 'No forced templates', 'A plan built around you'],
      },
    },
    hero: {
