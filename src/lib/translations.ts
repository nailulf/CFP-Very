    ...
    konsultasi: {
      ...
      booking: {
        ...
        confirm: {
          ...
          total: 'Total',
          note: 'Belum ada pembayaran online untuk saat ini. Setelah booking, tim kami akan menghubungimu via WhatsApp untuk mengatur jadwal dan pembayaran.',
          submit: 'Konfirmasi Booking',
        },
        success: {
          title: 'Booking diterima!',
          body: 'Booking-mu sudah kami catat. Tim kami akan menghubungimu via WhatsApp untuk mengonfirmasi jadwal dan mengatur langkah selanjutnya.',
